...
strimzipodset.core.strimzi.io/my-cluster-broker       3      3            3              92s
strimzipodset.core.strimzi.io/my-cluster-controller   3      3            3              92s
...
pod/my-cluster-broker-0                          1/1     Running   0          92s
pod/my-cluster-broker-1                          1/1     Running   0          92s
pod/my-cluster-broker-2                          1/1     Running   0          92s
pod/my-cluster-controller-3                      1/1     Running   0          91s
pod/my-cluster-controller-4                      1/1     Running   0          91s
pod/my-cluster-controller-5                      1/1     Running   0          91s
pod/my-cluster-entity-operator-cfd6759f9-r45rl   2/2     Running   0          28s
pod/strimzi-cluster-operator-7fb8ff4bd-m49ck     1/1     Running   0          115s
```
...
statefulsets
replicasets
    replicaset.apps/my-cluster-entity-operator-cfd6759f9
configmaps
    configmap/my-cluster-broker-0
    configmap/my-cluster-broker-1
    configmap/my-cluster-broker-2
    configmap/my-cluster-controller-3
    configmap/my-cluster-controller-4
    configmap/my-cluster-controller-5
...
pods
    ...
    pod/my-cluster-broker-1
    pod/my-cluster-broker-2
    pod/my-cluster-controller-3
    pod/my-cluster-controller-4
    pod/my-cluster-controller-5
    pod/my-cluster-entity-operator-cfd6759f9-r45rl
persistentvolumeclaims
    persistentvolumeclaim/data-my-cluster-broker-0
    persistentvolumeclaim/data-my-cluster-broker-1
    persistentvolumeclaim/data-my-cluster-broker-2
    persistentvolumeclaim/data-my-cluster-controller-3
    persistentvolumeclaim/data-my-cluster-controller-4
    persistentvolumeclaim/data-my-cluster-controller-5
ingresses
routes
clusterroles
...
clusteroperator
    ...
    pod/strimzi-cluster-operator-7fb8ff4bd-m49ck
...
logs
    ...
    my-cluster-broker-1
    my-cluster-broker-2
    my-cluster-controller-3
    my-cluster-controller-4
    my-cluster-controller-5
    my-cluster-entity-operator-cfd6759f9-r45rl
Report file report-05-09-2024_14-04-06.zip created
```
