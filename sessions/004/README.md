...
```sh
$ envsubst < sessions/004/install/apicurio.yaml | kubectl create -f -
...
$ curl -s -X POST -H "Content-Type: application/json" \
  ...
  -d @sessions/004/install/greeting.avsc \
...
```sh
$ envsubst < sessions/004/install/application.yaml | kubectl create -f -
