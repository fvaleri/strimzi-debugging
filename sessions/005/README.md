...
```sh
$ krun /opt/kafka/bin/kafka-producer-perf-test.sh --topic my-topic --record-size 100 --num-records 1000000 \
...
$ krun /opt/kafka/bin/kafka-run-class.sh kafka.tools.GetOffsetShell \
...
$ krun /opt/kafka/bin/kafka-producer-perf-test.sh --topic my-topic --record-size 100 --num-records 30000000 \
  --throughput -1 --producer-props acks=1 bootstrap.servers=my-cluster-kafka-bootstrap:9092
