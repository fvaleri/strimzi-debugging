...
$ krun /opt/kafka/bin/kafka-producer-perf-test.sh --topic my-topic --record-size 1000 --num-records 12000000 \
...
```sh
$ krun /opt/kafka/bin/kafka-console-producer.sh --bootstrap-server my-cluster-kafka-bootstrap:9092 --topic my-topic
aaa
>bbb
>ccc
...
$ krun /opt/kafka/bin/kafka-topics.sh --bootstrap-server my-cluster-kafka-bootstrap:9092 --list
__consumer_offsets
...
$ for topic in "__strimzi_store_topic" ".*topic-store-changelog"; do
  krun /opt/kafka/bin/kafka-topics.sh --bootstrap-server my-cluster-kafka-bootstrap:9092 --topic $topic --delete
done
...
# drumroll
$ krun /opt/kafka/bin/kafka-console-consumer.sh --bootstrap-server my-cluster-kafka-bootstrap:9092 \
