...
pvc-2609aaa7-3a13-4bc3-9d0a-cc19c4ccef50   1Gi        RWO            Delete           Bound    test/data-my-cluster-broker-10      gp3-csi        <unset>                          4m15s
pvc-55f69017-6ef9-4701-94ef-ffb90433cebd   1Gi        RWO            Delete           Bound    test/data-my-cluster-broker-11      gp3-csi        <unset>                          4m15s
...
my-cluster-broker-10  0/1     CrashLoopBackOff   8 (70s ago)   27m
my-cluster-broker-11  0/1     CrashLoopBackOff   8 (84s ago)   25m
my-cluster-broker-12  0/1     CrashLoopBackOff   8 (87s ago)   26m

$ kubectl exec my-cluster-broker-10 -- df -h /var/lib/kafka/data \
  && kubectl exec my-cluster-broker-11-- df -h /var/lib/kafka/data \
  && kubectl exec my-cluster-broker-12-- df -h /var/lib/kafka/data
...
$ kubectl get pv | grep my-cluster-broker
pvc-568b390e-d8a3-4efa-a528-dbd0934e18e8   1Gi        RWO            Delete           Bound    test/data-my-cluster-broker-11      gp3-csi        <unset>                          4m57s
pvc-875bbcc9-5f86-442e-9e05-f2b8852c83ce   1Gi        RWO            Delete           Bound    test/data-my-cluster-broker-10      gp3-csi        <unset>                          4m57s
pvc-c328aab2-8948-4791-88df-a488e9fd9faa   1Gi        RWO            Delete           Bound    test/data-my-cluster-broker-12      gp3-csi        <unset>                          4m57s
```
...
...
[2024-10-12 12:04:09,916] WARN [Producer clientId=perf-producer-client] Connection to node 5 (my-cluster-broker-10.my-cluster-kafka-brokers.test.svc/10.130.0.31:9092) could not be established. Node may not be available. (org.apache.kafka.clients.NetworkClient)
[2024-10-12 12:04:09,920] WARN [Producer clientId=perf-producer-client] Connection to node 7 (my-cluster-broker-12.my-cluster-kafka-brokers.test.svc/10.129.0.28:9092) could not be established. Node may not be available. (org.apache.kafka.clients.NetworkClient)
[2024-10-12 12:04:09,931] WARN [Producer clientId=perf-producer-client] Connection to node 6 (my-cluster-broker-11.my-cluster-kafka-brokers.test.svc/10.131.0.18:9092) could not be established. Node may not be available. (org.apache.kafka.clients.NetworkClient)
^C
...
$ kubectl logs my-cluster-broker-10| grep "No space left on device" | tail -n1
...
2024-10-12 12:10:08 INFO  PvcReconciler:137 - Reconciliation #1(watch) Kafka(test/my-cluster): Resizing PVC data-my-cluster-broker-10  from 1 to 10Gi.
2024-10-12 12:10:08 INFO  PvcReconciler:137 - Reconciliation #1(watch) Kafka(test/my-cluster): Resizing PVC data-my-cluster-broker-11  from 1 to 10Gi.
2024-10-12 12:10:08 INFO  PvcReconciler:137 - Reconciliation #1(watch) Kafka(test/my-cluster): Resizing PVC data-my-cluster-broker-12  from 1 to 10Gi.
...
$ kubectl get pv | grep my-cluster-broker
pvc-568b390e-d8a3-4efa-a528-dbd0934e18e8   10Gi       RWO            Delete           Bound    test/data-my-cluster-broker-11      gp3-csi        <unset>                          14m
pvc-875bbcc9-5f86-442e-9e05-f2b8852c83ce   10Gi       RWO            Delete           Bound    test/data-my-cluster-broker-10      gp3-csi        <unset>                          14m
...
$ kubectl get pv | grep my-cluster-broker
pvc-6efa4986-a8f8-42d3-ae80-0229d262cf81   1Gi        RWO            Delete           Bound    test/data-my-cluster-broker-12      gp3-csi        <unset>                          66s
pvc-d76d68c6-52e9-4a9f-a20f-3b052ea49c55   1Gi        RWO            Delete           Bound    test/data-my-cluster-broker-11      gp3-csi        <unset>                          66s
...
...
[2024-10-16 16:06:47,718] WARN [Producer clientId=perf-producer-client] Connection to node 5 (my-cluster-broker-10.my-cluster-kafka-brokers.test.svc/10.130.0.17:9092) could not be established. Node may not be available. (org.apache.kafka.clients.NetworkClient)
[2024-10-16 16:06:47,718] WARN [Producer clientId=perf-producer-client] Connection to node 7 (my-cluster-broker-12.my-cluster-kafka-brokers.test.svc/10.131.0.24:9092) could not be established. Node may not be available. (org.apache.kafka.clients.NetworkClient)
[2024-10-16 16:06:47,718] WARN [Producer clientId=perf-producer-client] Connection to node 6 (my-cluster-broker-11.my-cluster-kafka-brokers.test.svc/10.129.0.14:9092) could not be established. Node may not be available. (org.apache.kafka.clients.NetworkClient)
^C

$ kubectl get po | grep my-cluster-broker
my-cluster-broker-10                          0/1     CrashLoopBackOff   2 (12s ago)   3m41s
my-cluster-broker-11                          0/1     CrashLoopBackOff   2 (11s ago)   3m41s
my-cluster-broker-12                          0/1     CrashLoopBackOff   2 (14s ago)   3m41s
...
persistentvolumeclaim/data-my-cluster-broker-10-new created
persistentvolumeclaim/data-my-cluster-broker-11-new created
persistentvolumeclaim/data-my-cluster-broker-12-new created

$ kubectl get pvc | grep my-cluster-broker
data-my-cluster-broker-10      Bound     pvc-fe5ccdb3-b550-467e-b6e0-f4d3ece79ed0   1Gi        RWO            gp3-csi        <unset>                 8m25s
data-my-cluster-broker-10-new   Pending                                                                        gp3-csi        <unset>                 15s
data-my-cluster-broker-11      Bound     pvc-d76d68c6-52e9-4a9f-a20f-3b052ea49c55   1Gi        RWO            gp3-csi        <unset>                 8m25s
data-my-cluster-broker-11-new   Pending                                                                        gp3-csi        <unset>                 15s
data-my-cluster-broker-12      Bound     pvc-6efa4986-a8f8-42d3-ae80-0229d262cf81   1Gi        RWO            gp3-csi        <unset>                 8m25s
...
'/old/kafka-log10/.lock' -> '/new/kafka-log10/.lock'
'/old/kafka-log10/bootstrap.checkpoint' -> '/new/kafka-log10/bootstrap.checkpoint'
'/old/kafka-log10/recovery-point-offset-checkpoint' -> '/new/kafka-log10/recovery-point-offset-checkpoint'
'/old/kafka-log10/meta.properties' -> '/new/kafka-log10/meta.properties'
'/old/kafka-log10/__cluster_metadata-0/00000000000000000256.snapshot' -> '/new/kafka-log10/__cluster_metadata-0/00000000000000000256.snapshot'
'/old/kafka-log10/__cluster_metadata-0/partition.metadata' -> '/new/kafka-log10/__cluster_metadata-0/partition.metadata'
'/old/kafka-log10/__cluster_metadata-0/00000000000000000000.log' -> '/new/kafka-log10/__cluster_metadata-0/00000000000000000000.log'
'/old/kafka-log10/__cluster_metadata-0/00000000000000000000.index' -> '/new/kafka-log10/__cluster_metadata-0/00000000000000000000.index'
'/old/kafka-log10/__cluster_metadata-0/00000000000000000000.timeindex' -> '/new/kafka-log10/__cluster_metadata-0/00000000000000000000.timeindex'
'/old/kafka-log10/__cluster_metadata-0/leader-epoch-checkpoint.tmp' -> '/new/kafka-log10/__cluster_metadata-0/leader-epoch-checkpoint.tmp'
'/old/kafka-log10/__cluster_metadata-0/leader-epoch-checkpoint' -> '/new/kafka-log10/__cluster_metadata-0/leader-epoch-checkpoint'
...

$ kubectl get pv | grep my-cluster-broker
pvc-327097ee-094b-4725-afb9-1077b42f8504   10Gi       RWO            Delete           Bound    test/data-my-cluster-broker-11-new   gp3-csi        <unset>                          106s
pvc-5f306a61-0d84-4cbb-b1b4-8e05728f0397   10Gi       RWO            Delete           Bound    test/data-my-cluster-broker-10-new   gp3-csi        <unset>                          2m6s
pvc-6efa4986-a8f8-42d3-ae80-0229d262cf81   1Gi        RWO            Delete           Bound    test/data-my-cluster-broker-12      gp3-csi        <unset>                          24m
pvc-777daab8-91e0-4560-8c12-e22318ffd9df   10Gi       RWO            Delete           Bound    test/data-my-cluster-broker-12-new   gp3-csi        <unset>                          84s
pvc-d76d68c6-52e9-4a9f-a20f-3b052ea49c55   1Gi        RWO            Delete           Bound    test/data-my-cluster-broker-11      gp3-csi        <unset>                          24m
...
$ kubectl get pv | grep my-cluster-broker
pvc-13e660ba-6a21-4bad-876b-cabab93ce38b   1Gi        RWO            Retain           Bound    test/data-my-cluster-broker-11      gp3-csi        <unset>                          14m
pvc-2522a5ad-5275-4459-83f0-149d8cd007f3   10Gi       RWO            Retain           Bound    test/data-my-cluster-broker-11-new   gp3-csi        <unset>                          79s
pvc-26590b0f-c1ba-4069-9c24-f731287a7ed3   10Gi       RWO            Retain           Bound    test/data-my-cluster-broker-10-new   gp3-csi        <unset>                          100s
pvc-35fed9c0-f12f-4012-899a-759add4cef4e   10Gi       RWO            Retain           Bound    test/data-my-cluster-broker-12-new   gp3-csi        <unset>                          57s
pvc-aed21c6a-3b78-4a18-8e44-596285652b9d   1Gi        RWO            Retain           Bound    test/data-my-cluster-broker-10      gp3-csi        <unset>                          14m
...
persistentvolumeclaim "data-my-cluster-broker-10" deleted
persistentvolumeclaim "data-my-cluster-broker-10-new" deleted
...
persistentvolumeclaim/data-my-cluster-broker-10created
persistentvolumeclaim "data-my-cluster-broker-11" deleted
persistentvolumeclaim "data-my-cluster-broker-11-new" deleted
...
persistentvolumeclaim/data-my-cluster-broker-11created
persistentvolumeclaim "data-my-cluster-broker-12" deleted
persistentvolumeclaim "data-my-cluster-broker-12-new" deleted
...
persistentvolumeclaim/data-my-cluster-broker-12created

$ kubectl get pvc | grep my-cluster-broker
data-my-cluster-broker-10      Bound    pvc-26590b0f-c1ba-4069-9c24-f731287a7ed3   10Gi       RWO            gp3-csi        <unset>                 25s
data-my-cluster-broker-11      Bound    pvc-2522a5ad-5275-4459-83f0-149d8cd007f3   10Gi       RWO            gp3-csi        <unset>                 21s
...
$ kubectl get po | grep my-cluster-broker
my-cluster-broker-10                          1/1     Running   0          4m34s
my-cluster-broker-11                          1/1     Running   0          4m34s
my-cluster-broker-12                          1/1     Running   0          4m33s
